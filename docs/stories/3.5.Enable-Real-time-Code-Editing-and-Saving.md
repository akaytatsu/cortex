...
- `/apps/web/app/components/CodeViewer.tsx` - Converted to editable mode with save functionality
...
**New Files:**
- `/apps/web/app/routes/api.workspaces.$workspaceName.file.save.tsx` - Save API endpoint
