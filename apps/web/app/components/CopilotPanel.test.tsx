...
describe("CopilotPanel Component", () => {
  ...
  it("renders without sessionId", () => {
    ...
    expect(
      screen.getByText("Aguardando mensagens do copiloto...")
    ).toBeInTheDocument();
    expect(
      screen.getByText("Selecione uma sessão ativa para começar")
    ).toBeInTheDocument();
  });
  ...
  it("shows connected status when connected", () => {
    ...
    const statusIndicator =
      screen.getByText("Conectado").previousElementSibling;
  ...
  it("shows connecting status when connecting", () => {
    ...
    const statusIndicator =
      screen.getByText("Conectando...").previousElementSibling;
  ...
  it("shows processing indicator when processing", () => {
    ...
    const processingIndicator =
      screen.getByText("Processing...").previousElementSibling;
  ...
  it("shows appropriate message when connected but no messages", () => {
    ...
    expect(
      screen.getByText("Conectado, aguardando atividade...")
    ).toBeInTheDocument();
  });
});
